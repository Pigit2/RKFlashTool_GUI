...
QT_MOC_LITERAL(3, 23, 6) // "detect"

    },
    "DetectThread\0finished\0\0detect"
};
...
void DetectThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DetectThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DetectThread::finished)) {
                *result = 0;
                return;
            }
        }
